...
public class ContentActivity15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_content15);
        iv_back= findViewById(R.id.iv_back15);
        ...
        WebView myWebView = findViewById(R.id.webview16);
        String contentAsset ="file:///android_asset/HTML_Introduction.html";
